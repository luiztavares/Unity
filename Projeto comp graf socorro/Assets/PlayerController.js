...
function Update() {
	...
	//	controller.height = 0.5;  //// [e aqui que modifica o collider;
	 if ((_characterState == CharacterState.Crouch) || (_characterState == CharacterState.CrouchRun) || (_characterState == CharacterState.CrouchWalk))
	 {
	 	controller.height = 1;
	 	controller.center.y = 0.5;
	 	gameObject.GetComponent(PlayerCamera).distance = 2;
	 	gameObject.GetComponent(PlayerCamera).height = 0;
	 }
	 else
	 {
	 	controller.height = 2;
	 	controller.center.y = 1;
	 	gameObject.GetComponent(PlayerCamera).distance = 3;
	 	gameObject.GetComponent(PlayerCamera).height = 1;
	 }
	if (!isControllable)
	{
